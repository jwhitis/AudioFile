...
class TrackUnitTest < Test::Unit::TestCase
  ...
  def test_a11_write_tag_sets_title_property
  ...
  def test_a12_write_tag_sets_artist_property
    track = Track.new("test_audio/write_test.mp3")
  ...
  def test_a13_write_tag_sets_album_property
    track = Track.new("test_audio/write_test.mp3")
  ...
  def test_a14_write_tag_sets_track_property
    track = Track.new("test_audio/write_test.mp3")
  ...
  def test_a15_write_tag_sets_year_property
    track = Track.new("test_audio/write_test.mp3")
  ...
  def test_a16_write_tag_sets_genre_property
    track = Track.new("test_audio/write_test.mp3")
  ...
  def test_a17_write_tag_sets_comment_property
    track = Track.new("test_audio/write_test.mp3")
  ...
  def test_a18_rename_changes_filepath
  ...
  def test_a19_rename_updates_filepath_instance_variable
    track = Track.new("test_audio/rename_test.mp3")
  ...
  def test_a20_filename_removes_directory_and_extension_from_filepath
    track = Track.new("test_audio/test.mp3")
    assert_equal("test", track.filename)
  end

  def test_a21_filename_removes_leading_digits_and_whitespace
    track = Track.new("test_audio/01 This Is Not My Life.mp3")
    assert_equal("This Is Not My Life", track.filename)
  end

  def test_a22_filename_replaces_hyphens_and_underscores
    track = Track.new("test_audio/02 - Lucky_Denver_Mint.mp3")
    assert_equal("Lucky Denver Mint", track.filename)
  end

  def test_a23_get_metadata_returns_a_hash_of_metadata
  ...
  def test_a24_get_metadata_updates_metadata_instance_variable
    client_id = "309248-02139F04093408231C76178AE1A01581"
    api = Gracenote.new(client_id)
    track = Track.new("test_audio/03 Digital Love.mp3")
    track.metadata = {
