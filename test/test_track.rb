...
class TrackUnitTest < Test::Unit::TestCase
  ...
  def test_03_update_changes_filename
  ...
  def test_04_update_changes_filepath_instance_variable
    client_id = "309248-02139F04093408231C76178AE1A01581"
    api = Gracenote.new(client_id)
    track = Track.new("test_audio/update_test.mp3")
    track.update(api)
  ...
  def test_05_update_sets_metadata_tag_properties
    client_id = "309248-02139F04093408231C76178AE1A01581"
    api = Gracenote.new(client_id)
    track = Track.new("test_audio/update_test.mp3")
    track.update(api)
  ...
  def test_06_update_changes_metadata_instance_variable
    client_id = "309248-02139F04093408231C76178AE1A01581"
    api = Gracenote.new(client_id)
    track = Track.new("test_audio/update_test.mp3")
    track.update(api)
  ...
  def test_07_read_tag_returns_hash_with_song_title
    track = Track.new("test_audio/read_test.mp3")
    metadata = track.read_tag
    assert_equal("Hanging On The Telephone", metadata[:title])
  end

  def test_08_read_tag_returns_hash_with_artist_name
    track = Track.new("test_audio/read_test.mp3")
    metadata = track.read_tag
    assert_equal("The Nerves", metadata[:artist])
  end

  def test_09_read_tag_returns_hash_with_album_name
    track = Track.new("test_audio/read_test.mp3")
    metadata = track.read_tag
    assert_equal("One Way Ticket", metadata[:album])
  end

  def test_10_read_tag_returns_hash_with_track_number
    track = Track.new("test_audio/read_test.mp3")
    metadata = track.read_tag
    assert_equal(3, metadata[:track])
  end

  def test_11_read_tag_returns_hash_with_release_year
    track = Track.new("test_audio/read_test.mp3")
    metadata = track.read_tag
    assert_equal(2008, metadata[:year])
  end

  def test_12_read_tag_returns_hash_with_musical_genre
    track = Track.new("test_audio/read_test.mp3")
    metadata = track.read_tag
    assert_equal("Powerpop", metadata[:genre])
  end

  def test_13_read_tag_returns_hash_with_additional_comments
    track = Track.new("test_audio/read_test.mp3")
    metadata = track.read_tag
    assert_equal("Comment goes here", metadata[:comment])
  end

  def test_14_write_tag_sets_title_property
  ...
  def test_15_write_tag_sets_artist_property
    track = Track.new("test_audio/write_test.mp3")
  ...
  def test_16_write_tag_sets_album_property
    track = Track.new("test_audio/write_test.mp3")
  ...
  def test_17_write_tag_sets_track_property
    track = Track.new("test_audio/write_test.mp3")
  ...
  def test_18_write_tag_sets_year_property
    track = Track.new("test_audio/write_test.mp3")
  ...
  def test_19_write_tag_sets_genre_property
    track = Track.new("test_audio/write_test.mp3")
  ...
  def test_20_write_tag_sets_comment_property
    track = Track.new("test_audio/write_test.mp3")
  ...
  def test_21_open_tag_returns_error_message_if_tag_cannot_be_opened
    track = Track.new("test_dir/file1.txt")
    expected = {:error => "'file1.txt' cannot be opened."}
    assert_equal(expected, track.read_tag)
  end

  def test_22_process_tag_changes_metadata_instance_variable
    track = Track.new("test_audio/read_test.mp3")
  ...
  def test_23_get_properties_returns_hash_of_metadata
    track = Track.new("test_audio/read_test.mp3")
    TagLib::FileRef.open("test_audio/read_test.mp3") do |fileref|
      tag = fileref.tag
  ...
  def test_24_set_properties_sets_tag_properties
    track = Track.new("test_audio/write_test.mp3")
    track.metadata = {:artist => "The Nerves"}
    TagLib::FileRef.open("test_audio/write_test.mp3") do |fileref|
      tag = fileref.tag
  ...
  def test_25_title_from_filepath_removes_directory_and_extension
    track = Track.new("test_audio/test.mp3")
    track.metadata = {}
    assert_equal("test", track.title_from_filepath)
  end

  def test_26_title_from_filepath_replaces_underscores_with_spaces
    track = Track.new("test_audio/02_Lucky_Denver_Mint.mp3")
    track.metadata = {}
    assert_equal("02 Lucky Denver Mint", track.title_from_filepath)
  end

  def test_27_title_from_filepath_changes_metadata_instance_variable
  ...
  def test_28_get_metadata_returns_a_hash_of_metadata
    client_id = "309248-02139F04093408231C76178AE1A01581"
    api = Gracenote.new(client_id)
  ...
  def test_29_get_metadata_updates_metadata_instance_variable
    client_id = "309248-02139F04093408231C76178AE1A01581"
    api = Gracenote.new(client_id)
    track = Track.new("test_audio/03 Digital Love.mp3")
    track.metadata = {
  ...
  def test_30_get_metadata_returns_error_message_returned_by_search
    client_id = "309248-02139F04093408231C76178AE1A01581"
    api = Gracenote.new(client_id)
    track = Track.new("test_audio/test.mp3")
  ...
  def test_31_format_error_returns_formatted_error
  ...
  def test_32_rename_changes_filename
  ...
  def test_33_rename_changes_filepath_instance_variable
    track = Track.new("test_audio/rename_test.mp3")
  ...
  def test_34_filepath_from_metadata_creates_new_filepath_from_metadata
    track = Track.new("test_audio/test.mp3")
    track.metadata = {:title => "Praise Chorus", :track => 2}
    assert_equal("test_audio/02 Praise Chorus.mp3", track.filepath_from_metadata)
  end
